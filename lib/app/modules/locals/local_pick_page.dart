...
class _LocalPickPageState extends State<LocalPickPage> {
  ...
  Future<void> carregaLocais() async {
    ...
    await _loginController.fbInstance!.doc('akiregioes').collection('ceps/Lista').get().then((value) => value.docs.forEach((element) { locais.add(element['Cep'] + ' - ' + element['CepNome']); }));
  }
