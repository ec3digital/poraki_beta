...
class OffersController extends GetxController {
  ...
  Future<void> loadOffers() async {
    if (Get.arguments != null) {
      ...
      if (this.listName != null) {
        ...
        if (this.listName == 'offers1')
          await getOffers1(_loginController.qtyOfertas);

        if (this.listName == 'offers2')
          await getOffers2(_loginController.qtyOfertas);

        if (this.listName == 'offers3')
          await getOffers3(_loginController.qtyOfertas);

        if (this.listName == 'offers4')
          await getOffers4(_loginController.qtyOfertas);

        if (this.listName == 'favsoffers')
          await getOffersFavsByUser(
              _loginController.qtyOfertas); // getBestSellerOffers(limit);
      } else {
  ...
  Future<void> getOffers(int limit) async {
    try {
      ...
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffers() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getDayOfferByCEP(int limit) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getDayOfferByCEP() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOfferByCEPCategory(String category) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOfferByCEPCategory() controller ${e.toString()}',
          stackTrace);
    } finally {
      changeLoading(false);
    }
  ...
  Future<void> getOfferByCEPCategoryTitle(String title, String category) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOfferByCEPCategoryTitle() controller ${e.toString()}',
          stackTrace);
    } finally {
      changeLoading(false);
    }
  ...
  Future<void> getOfferByCEPTitle(String title) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOfferByCEPTitle() controller ${e.toString()}',
          stackTrace);
    } finally {
      changeLoading(false);
    }
  ...
  Future<void> getOffers1(int limit) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffers1() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffers2(int limit) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffers2() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffers3(int limit) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffers3() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffers4(int limit) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffers4() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffersBySeller(String sellerId) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffersBySeller() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffersByStore(String storeId) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffersByStore() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
  ...
  Future<void> getOffersFavsByUser(int qtyOfertas) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOffersFavsByUser() controller ${e.toString()}',
          stackTrace);
    } finally {
      changeLoading(false);
    }
  ...
  Future<void> getOfferById(int ofertaId) async {
    try {
      ...
      changeLoading(false);
      FirebaseCrashlytics.instance.recordError(
          'Erro no getOfferById() controller ${e.toString()}', stackTrace);
    } finally {
      changeLoading(false);
    }
  }
