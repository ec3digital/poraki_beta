                    ...
                    ButtonOffer(
                      onPressed: () {
                        ...
                        widget._controller.atualizaUsuario(new sqlUsuarios(
                            widget._controller.txtEmail.text.removeAllWhitespace,
                            ...
                            widget._controller.txtTelefone.text.removeAllWhitespace,
                            widget._controller.txtCEP.text.removeAllWhitespace,
                            widget._controller.txtEndereco.text.trimRight().trimLeft(),
                            widget._controller.txtNumero.text..trimRight().trimLeft(),
                            widget._controller.txtCompl.text.trimRight().trimLeft(),null,null,null));

                        final snackBar = SnackBar(
                          backgroundColor: AppColors.primaryColor,
                            content: Container( height: 40, child: Center(child: const Text('Informações salvas!'))));
